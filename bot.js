...
client.on("guildCreate", guild => {
  ...
  client.on("message", (message) => {
if (message.content.startsWith("1ct")) {
...
💎1server 『معلومات عن السيرفر』                      

💎1servers 『علشان تشوف البوت بكم سيرفر اون لاين 』  

💎1bot 『لمعرف البوت بكم سيرفر』

💎1date 『لمعرفه التاريخ』

💎1ping 『لمعرفه سرعه البوت』

💎1members 『معلومات عن الاعضاء』

💎1embed 『خاصيه غرد لكن بغير طريقه』

💎1say 『لي يكرر الكلام الذي تقوله』

💎1animal  『كود لي اضهار صور  للحيوانات』
...
client.on('message', msg => {
  if (msg.content === 'نورت') {
    msg.reply('ۛ ּا̍هــﻻ̍ۙ ۛ ּۄڛۜــﮪــﻻ̍ۙ ۖ بــگــمۘ ̨ڣــﮯ ڛۜــېْۧــڕڣــڔ ּهــﻻ̍ۙ ̨ۏﷲ ﷻ ۗ');
  }
});
